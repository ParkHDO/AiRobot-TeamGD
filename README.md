![image](https://github.com/user-attachments/assets/148b8173-dd71-499a-85a7-38645f6ba3b3)# 시각장애인을 위한 AI 기반 가이드 독
...
## 웹 & 앱
    카메라를 호출하여 실시간 스트리밍과 녹화를 진행합니다. 스트리밍 영상은 2분 간격으로 녹화되며, 녹화된 영상은 "Saved Videos"에 저장됩니다. 저장된 영상은 "Video Play Back" 기능을 통해 재생할 수 있습니다.
